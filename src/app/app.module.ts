...
import { HttpClientModule }  from '@angular/common/http';// adicionado o import para o HttpClientModule
...
@NgModule({
  ...
  imports: [BrowserModule, AppRoutingModule, FormsModule, HttpClientModule], //adicionado o HttpClientModule
  providers: [],
